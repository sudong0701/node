<template>
    <div class="sdField">
        ...
        <div class="sdField_value">
            <input v-model="selfValue" :password="password" class="sdField_input" type="text" @input="oninput" @change="change" :placeholder="placeholder" :readonly="readonly" :disabled="disabled" @click="clickField">
        </div>
    </div>
</template>
